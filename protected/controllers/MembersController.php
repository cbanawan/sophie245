...
class MembersController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'getMember'),
				'users'=>array('*'),
			),
	...
	public function actionGetMember($code)
	{
		$member = Members::model()->find(
				array(
					'condition' => 'memberCode = :code',
					'params' => array(':code' => $code)
				)
			);
		
		$memberDetails = $member->attributes;
		$memberDetails['fullName'] = $member->fullName;
